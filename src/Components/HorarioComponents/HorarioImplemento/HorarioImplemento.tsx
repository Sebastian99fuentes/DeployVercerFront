import {
  ...
  import './HorarioImplemento.css';
  import FullCalendar from '@fullcalendar/react';
import { ReservasImplementoDto } from '../../../Services/Models/ReservaImplementos/ReservaImplementos';
import {  ReservasImplementoCreate, ReservasImplementoGet } from '../../../Services/Api/ReservasImplementosApi/ReservasImplementosApi';
  ...
  const HorarioImplemento: React.FC<Props> = ({ Id,nombreImple }: Props): React.JSX.Element => {
    const calendarRef = useRef<FullCalendar | null>(null); // Referencia al calendario
    const [events, setEvents] = useState<ReservasImplementoDto[]>([]); // Estado para eventos
    ...
    useEffect(() => {
      const fetchEvents = async () => {
        setLoading(true);
        try {
          const response = await ReservasImplementoGet(Id);
    ...
    const handleConfirmReservation = async (
      ...
      try {
        const response = await ReservasImplementoCreate(nombreImple,Id, startStr, endStr);
...
export default HorarioImplemento